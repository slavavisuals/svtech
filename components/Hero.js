...
const Hero = () => {
  return (
    <section
      id='home'
      className='flex overflow-hidden items-center pt-24 pb-8 bg-primary lg:bg-cover lg:bg-center xl:pb-10 xl:h-fit'
    >
      <div className='container mx-auto h-full'>
        <div className='flex flex-col items-center h-full xl:flex-row'>
          {/* Text and button grouped */}
          <div className='flex flex-col order-2 items-center xl:order-1 xl:w-3/4'>
